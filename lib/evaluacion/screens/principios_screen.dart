...
import 'package:lensysapp/evaluacion/screens/tablas_screen.dart' as tablas_screen;
      ...
      appBar: AppBar(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              // Usar DimensionService para obtener el nombre interno
              String nombreDimensionInternaActual = DimensionService.nombrePorId(widget.dimensionId);
                                          ...
                                          final resultado = await Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (_) => ComportamientoEvaluacionScreen(
                                                ...
                                                calificacionExistente: calificacionActual, dimension: '',
                                              ),
                                            ),
                                          );
                                          if (resultado != null) {
