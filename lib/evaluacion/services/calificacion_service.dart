...
class CalificacionService {
  ...
  Future<Calificacion?> getCalificacionExistente({
    ...
    // Normaliza el nombre del comportamiento para evitar errores por espacios o mayúsculas
    final comportamientoNormalizado = comportamiento.trim().toLowerCase();
    final resultado = lista.where((c) =>
      c.idEmpresa == idEmpresa &&
      c.idDimension == idDimension &&
      c.comportamiento.trim().toLowerCase() == comportamientoNormalizado
    ).toList();
